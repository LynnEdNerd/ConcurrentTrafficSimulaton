...
// adds a new vehicle to the queue and returns once the vehicle is allowed to enter the intersection
void Intersection::addVehicleToQueue(std::shared_ptr<Vehicle> vehicle)
{
    ...
    // Once vehicle has been cleared to enter the intersection, make sure that the traffic light is green prior to 
